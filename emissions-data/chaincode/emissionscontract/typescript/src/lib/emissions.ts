...
export class EmissionsRecord extends State {
    ...
    fromBuffer(buf: Uint8Array): EmissionsRecord {
        return new EmissionsRecord(State.deserialize<EmissionsRecordInterface>(buf));
    }
}
...
export class EmissionRecordState extends WorldState<EmissionsRecordInterface> {
    ...
    async addEmissionsRecord(record: EmissionsRecord, uuid: string): Promise<void> {
    ...
    async updateEmissionsRecord(record: EmissionsRecord, uuid: string): Promise<void> {
