...
export async function recordEmission(req: Request, res: Response) {
  try {
    let file: Buffer;
    if (req.file) {
...
export async function getEmissionsData(req: Request, res: Response) {
  try {
...
export async function getAllEmissionsData(req: Request, res: Response) {
  try {
...
export async function getAllEmissionsDataByDateRange(req: Request, res: Response) {
  try {
...
export async function recordAuditedEmissionsToken(req: Request, res: Response) {
  try {
