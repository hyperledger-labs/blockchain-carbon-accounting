  ...
  try {
    ...
    const connectionProfileJson = (
      await fs.promises.readFile(
        "../organizations/peerOrganizations/auditor1.carbonAccounting.com/connection-auditor1.json"
      )
    ).toString();
...
async function fabricClient() {
  try {
    ...
    var channel = await client.queryPeers(
      "grpcs://internal-af58e5e8b9bef11eab3850a6b3b1ba41-1789620656.eu-central-1.elb.amazonaws.com:31043",
      0
    );
